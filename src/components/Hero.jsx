        ...
        <div className="relative z-20 text-center">
          ...
          <h2 className="text-md md:text-xl lg:text-2xl text-neutral-300 mt-4">
            ...
            <span className="text-indigo-300 font-semibold typing-text">
              <Typewriter
                words={[
                  "Intelligent that Learn and adapts.",
                  "the next wave of generative innovation",
                  "Solution that untangle the impossible.",
                  "visions that shape tommorrow's reality",
                  "Crafting Intelligent Apps for Every Horizon",
                  "Breathing Life into  AI 3D Worlds",
                ]}
                loop={0}
                cursor
                cursorStyle="_"
          ...
          <div className="flex justify-center gap-4 mt-6 text-2xl">
            ...
            <a
              href="https://www.instagram.com/rohithgowda333/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/rohith-gowda-python-developer/"
              target="_blank"
              rel="noopener noreferrer"
